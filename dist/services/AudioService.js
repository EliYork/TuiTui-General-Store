...
function pushLittleEndian32(bytes, value) {
    bytes.push(value & 255, (value >> 8) & 255, (value >> 16) & 255, (value >> 24) & 255);
}
function getEnvelopeGain(timeSec, durationSec, attackSec, releaseSec) {
...
function createWavDataUri(spec) {
...
function getSoundDataUri(sound) {
...
function playSound(name) {
    ...
    audio.loop = false;
    audio.volume = 1;
    audio.src = getSoundDataUri(name);
    audio.onError(() => {
