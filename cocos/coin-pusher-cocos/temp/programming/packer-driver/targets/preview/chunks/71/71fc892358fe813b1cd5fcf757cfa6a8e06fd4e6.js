    ...
    execute: function () {
      ...
      _export("CoinSpawner", CoinSpawner = (_dec = ccclass('CoinSpawner'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property({
        ...
        spawnCoin() {
          ...
          var coinNode = instantiate(this.coinPrefab);
          var parent = (_this$coinRoot = this.coinRoot) != null ? _this$coinRoot : this.node;
          parent.addChild(coinNode);
          var basePosition = this.spawnPoint ? this.spawnPoint.worldPosition : this.node.worldPosition;
          ...
          var coin = coinNode.getComponent(_crd && CoinBehaviour === void 0 ? (_reportPossibleCrUseOfCoinBehaviour({
            error: Error()
