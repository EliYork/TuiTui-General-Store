    ...
    execute: function () {
      ...
      _export("CoinSpawner", CoinSpawner = (_dec = ccclass('CoinSpawner'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property({
        ...
        spawnCoin(itemPrefab, request) {
          ...
          var itemNode = instantiate(itemPrefab);
          var parent = (_this$coinRoot = this.coinRoot) != null ? _this$coinRoot : this.node;
          parent.addChild(itemNode);
          var basePosition = this.resolveBasePosition(request);
          var shouldRandomize = this.shouldRandomizePosition(request);
          var rotationSource = (_this$spawnPoint = this.spawnPoint) != null ? _this$spawnPoint : this.node;
          ...
          var tiltX = this.baseTiltXDegrees + randomRange(-this.randomTiltXDegrees, this.randomTiltXDegrees);
          var tiltZ = this.baseTiltZDegrees + randomRange(-this.randomTiltZDegrees, this.randomTiltZDegrees);
          var yaw = this.spawnYawDegrees + randomRange(-this.randomYawDegrees, this.randomYawDegrees);
          ...
          var item = itemNode.getComponent(_crd && CoinBehaviour === void 0 ? (_reportPossibleCrUseOfCoinBehaviour({
            error: Error()
        ...
        getBaseSpawnWorldPosition(out) {
          var _out, _this$spawnPoint$worl, _this$spawnPoint2;

          if (out === void 0) {
            out = null;
          }

          var target = (_out = out) != null ? _out : new Vec3();
          var source = (_this$spawnPoint$worl = (_this$spawnPoint2 = this.spawnPoint) == null ? void 0 : _this$spawnPoint2.worldPosition) != null ? _this$spawnPoint$worl : this.node.worldPosition;
