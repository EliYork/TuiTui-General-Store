    ...
    execute: function () {
      ...
      _export("CoinBehaviour", CoinBehaviour = (_dec = ccclass('CoinBehaviour'), _dec2 = property({
        ...
        applySpawnAssist() {
          ...
          var horizontalSpeed = Math.hypot(this._linearVelocity.x, this._linearVelocity.z);

          if (horizontalSpeed > this.maxSpawnHorizontalSpeed && horizontalSpeed > 0) {
            var ratio = this.maxSpawnHorizontalSpeed / horizontalSpeed;
        ...
        applySettleAssist(deltaTime) {
          ...
          var horizontalSpeed = Math.hypot(this._linearVelocity.x, this._linearVelocity.z);
          var verticalSpeed = Math.abs(this._linearVelocity.y);
