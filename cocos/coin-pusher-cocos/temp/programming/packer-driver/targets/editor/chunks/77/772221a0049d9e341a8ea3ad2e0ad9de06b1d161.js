    ...
    execute: function () {
      ...
      _export("PusherController", PusherController = (_dec = ccclass('PusherController'), _dec2 = property({
        ...
        migrateLegacyTravelOffsetIfNeeded() {
          const splitParamsStillDefault = nearlyEqual(this.pushOffsetX, DEFAULT_PUSH_OFFSET_X) && nearlyEqual(this.pushFloatY, DEFAULT_PUSH_FLOAT_Y) && nearlyEqual(this.pushOffsetZ, DEFAULT_PUSH_OFFSET_Z);
          const legacyOffsetChanged = !nearlyEqual(this.travelOffset.x, DEFAULT_LEGACY_TRAVEL_OFFSET.x) || !nearlyEqual(this.travelOffset.y, DEFAULT_LEGACY_TRAVEL_OFFSET.y) || !nearlyEqual(this.travelOffset.z, DEFAULT_LEGACY_TRAVEL_OFFSET.z);
