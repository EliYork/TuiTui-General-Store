...
export class PusherRenderer {
  render(
    ...
    context.fillRect(
      boardLeft,
      boardBottom - Math.max(6, pusher.thickness * 0.72),
      boardWidth,
      Math.max(6, pusher.thickness * 0.72)
    );
    ...
    context.strokeRect(
      ...
      Math.max(2, boardBottom - visibleTop - 2)
    );
